...
class GovernanceBedrockStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        # Scope 3: Scope 2 + StagingDeployment (S3 GetObject + S3 PutObject + DynamoDB PutItem/UpdateItem/GetItem)
        ...
        # Scope 4: Full autonomy (full S3 + DynamoDB + logs access)
        ...
        # --- Task 9.2: Action Group Lambda resource and IAM role ---

        # Action Group Lambda role with Scope 1 boundary by default
        ...
        # CloudWatch log group for agent actions
        ...
        # Grant S3 read/write and DynamoDB read/write
        ...
        # --- Task 9.3: Bedrock Agent resource with action groups ---
        ...
        # Load OpenAPI schemas as inline payloads for Bedrock Agent action groups
        ...
        # Also deploy schemas to S3 for reference
        ...
        # Schemas are embedded inline via payload, no S3 dependency needed
        ...
        # Bedrock Agent Alias (points to prepared version via auto_prepare)
        ...
        # --- Task 9.4: Scope Enforcer and Kill Switch Lambda resources ---

        # Build the scope boundary ARNs mapping for environment variable
        ...
        # --- Task 9.5: CloudTrail trail (conditional) ---
        # CloudWatch log group already created above as self.agent_log_group
        ...
        if not skip_cloudtrail:
            ...
            # S3 data events on Data Bucket
            self.governance_trail.add_s3_event_selector(
                [cloudtrail.S3EventSelector(bucket=self.data_bucket)],
                read_write_type=cloudtrail.ReadWriteType.ALL,
            )

        # --- Task 9.6: Scope Table initialization and sample data deployment ---

        # Initialize Scope Table with default agent record (scope_level=1)
        ...
        # Upload sample_data/ contents to the Data Bucket

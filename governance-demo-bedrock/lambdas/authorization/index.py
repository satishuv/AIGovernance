...
def handler(event, context):
    ...
    if registry_table:
        ...
        if not agent_entry:
            ...
            return result
        result["agent_environment"] = agent_entry.get("environment", "")

    # 3. Environment Isolation
    if registry_table and result["agent_environment"]:
        isolation = EnvironmentIsolation()
        env_allowed = isolation.check_environment_access(

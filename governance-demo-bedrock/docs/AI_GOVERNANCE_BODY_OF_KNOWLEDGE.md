...
- 24.1 8,470+ Attack Payloads (13 academic benchmarks)
- 24.2 93.4% Detection Rate (methodology and results)
...
| Domain 9: AI Threat Intelligence | `threat_detector.py`, 8,470+ attack dataset |
